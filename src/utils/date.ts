...
const railFormatter = new Intl.DateTimeFormat("tr-TR", {
	day: "numeric",
	month: "short",
	year: "numeric",
});
...
const bylineFormatter = new Intl.DateTimeFormat("tr-TR", {
	day: "numeric",
	month: "long",
	year: "numeric",
});

const eyebrowFormatter = new Intl.DateTimeFormat("tr-TR", {
	month: "long",
	year: "numeric",
});
